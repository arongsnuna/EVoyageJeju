  ...
  return (
    <Container>
      ...
      <FirstChartContainer>
        ...
        <ExplanationRight>
          <Title>제주도는 지금?!</Title>
          <p>제주도의 차량 CO2 배출량 증가함과 동시에 제주도 전기차 보유 대수 또한 증가하고 있습니다.</p>
          <p>이는 전기차 보급량에 비해 전기차 사용이 적다는 문제점을 보여줍니다.</p>
        </ExplanationRight>
      </FirstChartContainer>
      <SecondChartContainer>
        <ExplanationLeft>
          <Title>제주도의 전기차 수</Title>
          <p>2020년 제주도의 인구는 2번째로 적지만 전기차량 보유 대수는 전국 상위권을 유지하고 있습니다.</p>
          <p>이것은 제주도 관광객을 위한 렌트용 전기차는 많다는 것을 알수있습니다.</p>
        </ExplanationLeft>
        <SecondGraphContainer>
          <PopulationBarChart />
        </SecondGraphContainer>
